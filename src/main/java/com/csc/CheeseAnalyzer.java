...
public class CheeseAnalyzer {
  String fileName;
  int number_of_pastuerized_milk = 0,
  ...
  public void analyzeCheeseData(String fileName) {
    try {
      ...
      String line = reader.readLine(); // skips header line
  ...
  try {
    ...
    writer.write("The number of cheeses that use pasteurized milk is: " + number_of_pastuerized_milk);
    writer.write("The number of cheese that use raw milk is: " + number_of_raw_milk);
    writer.write("The number of organic cheeses that have a moisture percentage greather than 41.0% is: " + number_of_organic_cheese_moisture_greater_than_forty_percent);
    writer.write("The animal that most cheeses in Canada comes from are: " + mostAnimal);
    writer.close();
  } catch (IOException e) {
    e.printStackTrace();
  }
